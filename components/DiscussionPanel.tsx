...
interface Msg { id: string; author_id: string | null; author_name: string | null; body: string; created_at: string; so_number: string | null }
      ...
      {open && (
        <div className="px-4 pb-4">
          ...
          <div className="flex flex-wrap gap-2">
            <input list="disc-so-list" value={tagSo} onChange={e => setTagSo(e.target.value)} placeholder="Link SO# (optional)" className="w-40 border rounded-lg px-3 py-2 text-sm" />
