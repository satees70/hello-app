...
const fields: Field[] = [
  ...
  { key: 'oven_timer', label: 'Oven — drying time (click Start/Finish)', type: 'timer', startKey: 'oven_time_start', finishKey: 'oven_time_finish', wide: true },
  { key: 'roast_temp', label: 'CCP4 Roasting — Temp (°C)' },
  { key: 'roast_achieve_temp', label: 'Roasting — starts at (°C, 30/60 min)' },
  { key: 'roast_timer', label: 'Roasting — time (click Start/Finish)', type: 'timer', startKey: 'roast_time_start', finishKey: 'roast_time_finish', wide: true },
